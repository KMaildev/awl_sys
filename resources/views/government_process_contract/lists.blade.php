    ...
    <tr>
        ...
        <td class="text-center">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="{{ route('government_process_contract.edit', $government_proces->id) }}">
                    Edit
                </a>

                <form action="{{ route('government_process_contract.destroy', $government_proces->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
